...
img = cv2.imread('./test_images/Shubham Sawant.jpg', 0)
img_lbp = cv2.imread('./test_images/Shubham Sawant.jpg', 0)
...
cv2.imwrite('./test_images/Shubham Sawant_lbp.png', img_lbp)
...
plt.figure()
plt.hist(hist, bins)
plt.savefig('Shubham Sawant_hist.png')
plt.figure()
plt.hist(hist_lbp, bins_lbp)
plt.savefig('Shubham Sawant_lbp_hist.png')
