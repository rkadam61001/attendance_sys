...
from databaseTest import create_connection
class Student:
    def __init__(self,root):
        ...
        # Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="mint cream") #bd mean border 
        ...
        dep_combo["values"]=("Select Department","CSE","IT","ELECTRONICS","ELECTRICAL","CIVIL")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","GIS","Parallel Computing","Software Reliability","Agile Lab")
        cou_combo.current(0)
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Session:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = create_connection()
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Divison=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher_Name=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Divison,Gender,DOB,Mobile_No,Address,Roll_No,Email,Teacher_Name,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
